...
<tr>
  <td colspan="2" style="height:20px; vertical-align:middle"><h3><b>Feature selection and Prediction using EM algorithm base on Multiple surrogates of true response</b></h3></td>
</tr>
<tr>
  <td colspan="2">
  ...
  * Constructed multiple simulation studies in different settings, including low dimension and high dimension under different assumptions.
  
  * Achieved improvement in AUC, ACC, TPR, TNR, PPV, NPV compared to Naive, Ad Hoc method.
...
<tr>
  ...
  * Constructed both logistic regression and Cox hazard model to estimate the effect size. 
  
  * Did power analysis to select the final model and tested interaction term.
