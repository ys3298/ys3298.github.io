...
<tr style="border-top:1pt solid black;">
  ...
  <td style="text-align:right; vertical-align:bottom"><font color="8B8A8A">- Research assistant, supervised by Professor Hua Shen, <br>Calgary University</font></td>
</tr>
<tr>
  <td colspan="2" style="height:20px; vertical-align:middle"><h3><b>Feature selection and Prediction using EM algorithm base on Multiple label-noise response</b></h3></td>
</tr>
<tr>
  <td colspan="2">
  ...
  * •	Combined EM algorithm and Adaptive LASSO to estimate sensitivity and specificity of each surrogate of ture response, did feature selection and prediction based on this algorithm. Achieved improvement in AUC, ACC, TPR, TNR, PPV, NPV compared to Naive, Ad Hoc method.
  
  * •	Constructed multiple simulation studies in different settings, including low dimension and high dimension under different assumptions and different penalty.
...
<tr>
  <td colspan="2" style="height:20px; vertical-align:middle"><h3><b>Metabolomics statistical analysis on Autism data</b></h3></td>
</tr>
<tr>
  <td colspan="2">
  ...
  * Detected outliers in dataset using PCA.
  
  * Constructed both logistic regression and Cox hazard model to estimate the effect size and tested interaction term.
  
  * Did power analysis to select the final model; After adjusted multiple comparison, found significant association between pseudo uridine and autism
  
  * Used Adaptive LASSO, Random Forest and XGBoosting to select features from high dimensional dataset and fit a final model with selected feature to do prediction.
