...
<tr>
  <td colspan="2" style="height:20px; vertical-align:middle"><h3><b>Variable selection and Prediction using EM algorithm base on Multiple label-noise response</b></h3></td>
</tr>
<tr>
  <td colspan="2">
...
<tr style="border-top:1pt solid black;">
  <th rowspan="3"><img src="" style="width:300%; float:left" class="center image-square"></a></th>
  <td style="vertical-align: bottom"><font color="8B8A8A">05/2020-08/2020</font></td>
...
<tr>
  ...
  * A manuscript is prepared

  * Constructed conditional logistic regression, feature selection and prediction base on one to one matched dataset. </td>
